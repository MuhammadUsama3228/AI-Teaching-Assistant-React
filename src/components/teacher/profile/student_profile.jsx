            ...
            case 1:
                return (
                    <>
                        ...
                        <TextField label="Degree" name="degree" fullWidth value={formData.degree} onChange={handleChange} required margin="normal" error={!!errors.degree} helperText={errors.degree?.[0]} />
                        <Box sx={{ mt: 2 }}>
                            <Typography gutterBottom>Year of Study: {formData.year_of_study}</Typography>
                            <Slider value={formData.year_of_study} onChange={handleSliderChange} step={1} marks min={1} max={4} valueLabelDisplay="auto" />
                        </Box>
                    </>
                );
            case 2:
                return (
                    <>
                        ...
                        <TextField label="Bio" name="bio" fullWidth value={formData.bio} onChange={handleChange} multiline rows={3} margin="normal" />
                        <FormControlLabel control={<Checkbox checked={formData.address_hide} onChange={handleCheckboxChange} name="address_hide" />} label="Hide Address" />
                    </>
                );
            default:
                return null;
